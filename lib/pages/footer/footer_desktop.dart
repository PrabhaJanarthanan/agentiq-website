                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _socialIcon(
                            Image.asset(ATImages.facebook,
                                color: ATColors.primaryColor),
                            'https://facebook.com'),
                        const SizedBox(width: ATSizes.spaceBtwItems),
                        _socialIcon(
                            Image.asset(ATImages.instagram,
                                color: ATColors.primaryColor),
                            'https://www.instagram.com/agentiq_things/'),
                        const SizedBox(width: ATSizes.spaceBtwItems),
                        _socialIcon(
                            Image.asset(ATImages.twitter,
                                color: ATColors.primaryColor),
                            'https://twitter.com'),
                        const SizedBox(width: ATSizes.spaceBtwItems),
                        _socialIcon(
                            Image.asset(ATImages.linkedin,
                                color: ATColors.primaryColor),
                            'https://linkedin.com'),
                      ],
                    )
